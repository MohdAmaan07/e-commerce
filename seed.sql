insert into core_collection (id, title, featured_product_id)
...
insert into core_product (id, title, description, price, inventory, last_updated, collection_id, slug)
...
insert into core_customer (id, first_name, last_name, email, phone, date_of_birth, membership)
...
insert into core_order (id, placed_at, payment_status, customer_id)
...
insert into core_orderitem (id, quantity, unit_price, order_id, product_id)
